👋 Olá, eu sou Estanislau Araújo Junior
...
Atualmente estou baseado no Brasil e busco oportunidades internacionais, especialmente na Irlanda, em ambientes de telecomunicações, ISPs e tecnologia.
...
(Os projetos serão adicionados e aprimorados continuamente como parte da minha evolução em programação)

🔹 Scripts de Automação – Automação de tarefas operacionais e rotinas de rede

🔹 Projetos Backend – APIs e aplicações de nível de sistema

🔹 Repositórios de Lógica e Desafios Técnicos – Exercícios e estudos práticos
...
⭐ Este perfil é um documento vivo e será atualizado conforme minha evolução como desenvolvedor de software.
